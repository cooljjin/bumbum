...
export function SettingsSidebar({
  ...
  return (
    <div className="p-6">
      ...
      {/* 룸 설정 */}
      <div className="mb-8">
        <h3 className="text-lg font-medium text-gray-700 mb-4">룸 설정</h3>
      ...
      {/* 도움말 */}
      <div>
        <h3 className="text-lg font-medium text-gray-700 mb-4">도움말</h3>
        ...
        {/* 키보드 단축키 */}
        <div className="mt-6">
          <h4 className="text-md font-medium text-gray-700 mb-3">키보드 단축키</h4>
